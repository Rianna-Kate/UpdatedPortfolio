...
export const Home = () => {
    return (
        <section className="headerSect" id="home">
            <div className="homeHeader">
                <div className="title">
                    <h1>Hello</h1>
                    <h1 className="name">
                        I'm <span className="highlight">Rianna</span>
                    </h1>
                    <div className="typeWriter">
                        <Typewriter 
                        options={{
                            strings: ['Java Developer', 'Back-End Developer', 
            ...
            <img src={"/prof-cropped.png"} alt="Alter" />
            </div>
            <div className="socialCard">
                <a className="social-link1" href="https://github.com/Rianna-Kate" target="_blank" rel="noopener noreferrer">
                ...
                <a className="social-link2" href="https://www.linkedin.com/in/rianna-armour/" target="_blank" rel="noopener noreferrer">
                ...
                <a className="social-link3" href="mailto:rianna.armour@hotmail.com">
